...
execute as @a[scores={ed_mana_tick=30,ed_mana=..4,ed_level=1}] run scoreboard players add @s ed_mana 1
execute as @a[scores={ed_mana_tick=30,ed_mana=..9,ed_level=2}] run scoreboard players add @s ed_mana 2
execute as @a[scores={ed_mana_tick=30,ed_mana=..19,ed_level=3}] run scoreboard players add @s ed_mana 3
execute as @a[scores={ed_mana_tick=30,ed_mana=..29,ed_level=4}] run scoreboard players add @s ed_mana 4
execute as @a[scores={ed_mana_tick=30,ed_mana=..39,ed_level=5}] run scoreboard players add @s ed_mana 5
execute as @a[scores={ed_mana_tick=30,ed_mana=..49,ed_level=6}] run scoreboard players add @s ed_mana 6
execute as @a[scores={ed_mana_tick=30,ed_mana=..99,ed_level=7}] run scoreboard players add @s ed_mana 7
execute as @a[scores={ed_mana_tick=30,ed_mana=5..,ed_level=1}] run scoreboard players set @s ed_mana 5
execute as @a[scores={ed_mana_tick=30,ed_mana=10..,ed_level=2}] run scoreboard players set @s ed_mana 10
execute as @a[scores={ed_mana_tick=30,ed_mana=20..,ed_level=3}] run scoreboard players set @s ed_mana 20
execute as @a[scores={ed_mana_tick=30,ed_mana=30..,ed_level=4}] run scoreboard players set @s ed_mana 30
execute as @a[scores={ed_mana_tick=30,ed_mana=40..,ed_level=5}] run scoreboard players set @s ed_mana 40
execute as @a[scores={ed_mana_tick=30,ed_mana=50..,ed_level=6}] run scoreboard players set @s ed_mana 50
execute as @a[scores={ed_mana_tick=30,ed_mana=100..,ed_level=7}] run scoreboard players set @s ed_mana 100
execute as @a[scores={ed_mana_tick=30}] run scoreboard players reset @s ed_mana_tick
execute as @a[scores={Wand=1..}] run scoreboard players reset @s ed_mana_tick
...
execute as @a[scores={ed_death=1..}] run scoreboard players set @s ed_mana 0